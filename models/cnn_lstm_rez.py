...
if __name__ == "__main__":
  ...
  RES_FILE = "./cnn_lstm_rez_results.csv"
  ...
  for stk in ["AAPL", "AMZN", "FB", "GOOG", "MSFT"]:
    PRED_FILE = "./predictions/cnn_lstm_rez_prediction_"+ stk +".csv"
    ...
    for i in range(1,10):
      # Set dates for 10-fold cross validation
        ...
        stk_train = vts.stock_get(stk + "_residuals", start_date, end_date)
        stk_test = vts.stock_get(stk + "_residuals", start_date_test, end_date_test)
        ...
        checkpoint_filepath = 'checkpoint/cnn_lstm_rez_' + stk + '_checkpoint/'
        ...
        model.save('models/cnn_lstm_rez_' + stk + "model.h5")
