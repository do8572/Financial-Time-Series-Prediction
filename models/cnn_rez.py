...
if __name__ == "__main__":
    ...
    for stk in ["AAPL", "AMZN", "FB", "GOOG", "MSFT"]:
        PRED_FILE = "./predictions/cnn_rez_prediction_"+ stk +".csv"
        ...
        for i in range(1,10):
            ...
            checkpoint_filepath = 'checkpoint/cnn_rez_' + stk + '_checkpoint/'
            ...
            model.save('models/cnn_rez_' + stk + "_model.h5")
