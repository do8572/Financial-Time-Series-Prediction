...
if __name__ == "__main__":
    ...
    for stk in ["AAPL", "AMZN", "FB", "GOOG", "MSFT"]:
        ...
        for i in range(1,10):
            ...
            checkpoint_filepath = 'checkpoint/lstm_rez_' + stk + '_checkpoint/'
            ...
            model.save('models/lstm_rez_' + stk + "_model.h5")
